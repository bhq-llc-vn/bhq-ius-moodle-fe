...
export const environment = {
  production: false,
  // apiUrl:'http://172.17.80.1:8098/bhq-ius/api',
  apiUrl:'http://localhost:8055/bhq-ius/api',
  // apiUrl:'http://localhost:8098/bhq-ius/api',
  gatewayUrl:'http://localhost:8055',
  // apiUrl: 'http://host.docker.internal:8055/bhq-ius/api',
