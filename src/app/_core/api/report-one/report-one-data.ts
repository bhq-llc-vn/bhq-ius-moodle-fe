...
export abstract class ReportOneData {
  ...
  abstract submitDriver(data: number[], courseId: number): Observable<any>;
  abstract submitCourse(data: number[]): Observable<any>;
  abstract submitAvatar(data: number[], courseId: number): Observable<any>;
  abstract submitEnroll(data: number[], courseId: number): Observable<any>;
